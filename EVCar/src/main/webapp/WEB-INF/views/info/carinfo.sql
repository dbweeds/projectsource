...
ALTER TABLE carinfo MODIFY support NULL;
...
update carinfo set support = 6730000 where bno=14;
update carinfo set support = 6490000 where bno=15;
update carinfo set support = 6050000 where bno=16;
update carinfo set support = 6050000 where bno=17;

update carinfo set chargetype = 'DC콤보' where bno=8;
